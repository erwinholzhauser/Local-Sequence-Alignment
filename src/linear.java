...
public class linear {
	...
	public static void main(String args[]) {
		...
		if(!cl.hasOption("a") || !cl.hasOption("b")) {
			...
			/*
			 * Find start and end indices of the leftmost local alignment with a linear-space,
			 * score-only version of Smith-Waterman.
			 */
			...
			/*
			 * Use Myers and Miller recursive, divide-and-conquer strategy to align the subsequences
			 * bracketed by the local alignment using Gotoh's linear-space conversion cost.
			 */
			diff(start_indices.x - 1, start_indices.y - 1, end_indices.x - start_indices.x + 1, end_indices.y - start_indices.y + 1);
